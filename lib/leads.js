...
//   RESEND_AUDIENCE_ID    — optional; if set, leads are added to this Resend Audience for broadcasts
...
export async function submitLead(_prevState, formData) {
  ...
  try {
    ...
    // 3) List-building for broadcasts (best-effort).
    ...
    if (audienceId) {
      try {
        ...
        console.error(`[lead:${kind}] audience add error:`, e);
      }
    }
