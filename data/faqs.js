// Homepage FAQ — answers the buyer questions the expert flagged (warranty,
// permitting, rush, pricing, areas). Rendered with FAQPage schema (the <Faq>
// component) so it can win rich results and feed AI answers. Keep q/a text
// matching what renders on the page word-for-word.
...
export const HOME_FAQS = [
  ...
  },
  {
    ...
    a: "Yes. We pull City of Houston sign permits and confirm your sign meets local code and your landlord's criteria before we fabricate anything, so your installation passes inspection the first time. Permitting is included as part of your project.",
  },
  {
