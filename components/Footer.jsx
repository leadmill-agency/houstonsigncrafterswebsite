        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><Link href="/quote" className="hover:text-white">Get My Free Quote</Link></li>
              <li><Link href="/book" className="hover:text-white">Book My Call</Link></li>
              ...
              <li><Link href="/sign-mockup" className="hover:text-white">Sign Mockup Tool</Link></li>
              <li><Link href="/community-boards" className="hover:text-white">Community Boards</Link></li>
