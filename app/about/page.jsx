      ...
      <section className="bg-cloud">
        <div className="mx-auto max-w-4xl px-4 py-14 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-steel">
            ...
            design, fabrication, permitting, and licensed installation. Business owners get a
      ...
      <section className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
        <div className="prose-content">
          ...
          <p>
            ...
            inspection. When you have a tight deadline, like a grand opening, a lease requirement, or an
