...
export function GET() {
  ...
  const lines = [
    ...
    `- [About](${B}/about)`,
    `- [Contact](${B}/contact)`,
    `- [For general contractors](${B}/general-contractors)`,
    `- [For property managers](${B}/property-managers)`,
    `- [Franchise & multi-location signage](${B}/franchise-signage)`,
    `- [Sign permits by jurisdiction](${B}/sign-permits)`,
    "",
    "## Services",
    "",
